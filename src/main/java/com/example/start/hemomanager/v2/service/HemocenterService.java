...
public class HemocenterService {
    ...
    public ResponseEntity<Hemocenter> createHemocenter(@RequestBody HemocenterSignInDTO hemocenterDTO) {
        if (hemocenterRepository.existsByEmailAndCnpj(hemocenterDTO.getEmail(), hemocenterDTO.getCnpj()))
    ...
    public ResponseEntity<List<Hemocenter>> getAllHemocenters() {
        ...
        if (hemocenterList.isEmpty())
            throw new ResponseStatusException(HttpStatus.NO_CONTENT, "Nenhum hemocentro encontrado.");
